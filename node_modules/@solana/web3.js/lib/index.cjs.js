  ...
  const clientBrowser = new RpcClient__default.default(async (request, callback) => {
    ...
    try {
      ...
      for (;;) {
        ...
        //console.error(`Hello mir responded with ${res.status} ${res.statusText}.  Retrying after ${waitTime}ms delay...`);
      ...
      if (err instanceof Error) console.log("too many requests");//callback(err);
    }
  }, {});
